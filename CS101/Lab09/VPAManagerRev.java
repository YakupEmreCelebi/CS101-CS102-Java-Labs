...
public class VPAManagerRev {
    ...
    private static void adoptNewPet(Scanner scanner) {
        String petName;
        if(currentUser.getUserPets().size() < 3)
        {
            boolean validName = false;
            do{
                System.out.print("Enter pet name: ");
                petName = scanner.nextLine();
                if( Character.isUpperCase(petName.charAt(0)))
                {
                    validName = true;
                }
                else
                {
                    System.out.println("Pet name must start with a capital letter");
                }
            }while(!validName);
            ...
            String petType = ""; // to silence the compiler
            int choice = scanner.nextInt();
            if(choice == 1)
            {
                petType = "Dog";
        ...
        {
            System.out.println("You cannot adopt more than 3 pets.");
        }
