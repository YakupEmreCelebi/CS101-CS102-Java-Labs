...
public class Lab03_Q3 {
    public static void main(String[] args) {
        ...
        else
        {
            ...
            {
                System.out.print("\n1- Add customer \n2- Delete customer \n3- Add item \n4- Delete item \n5- Logout \nSelect an operation:");
                System.out.print("Select ana operation: ");
                ...
                if(operation == 1)
                {
                    ...
                    {
                        System.out.println("New customer CrestviewCorporation is added! \nYour customers: (" + customers + addCustomer + " )");
                    }
                ...
                else if(operation == 2)
                {
                    ...
                    {
                        String newCustomersList = customers.replace(deleteCustomer, "");
                        System.out.println("EcoGoods is deleted successfully from customers! \nYour customers: ( " + newCustomersList + ")");
                    }
                    else
                    {
                ...
                else if(operation == 3)
                {
                    ...
                    if(itemIDList.contains(itemID))
                    {
                        ...
                        System.out.println("Your items: Item104:Laptop Item125:Monitor");
                    }
                    else
                    {
